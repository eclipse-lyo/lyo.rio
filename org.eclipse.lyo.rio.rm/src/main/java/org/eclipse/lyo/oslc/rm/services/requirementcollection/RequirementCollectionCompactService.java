 ...
 */
public class RequirementCollectionCompactService extends RioBaseService {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("reqcol", resource); //$NON-NLS-1$
		String preview = null;
		if( "large".equals(previewType) ) { //$NON-NLS-1$
			preview = "/rm/reqcol_largePreview.jsp"; //$NON-NLS-1$
		} else {
			preview = "/rm/reqcol_smallPreview.jsp"; //$NON-NLS-1$
		}
