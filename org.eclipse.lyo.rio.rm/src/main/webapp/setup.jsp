...
<title>Simple OSLC RM Reference Implementation Setup</title>
</head>
<body>
<table><tr><td><a href="/rio-rm"><img border="0" src="oslcLg.png"/></a></td><td><h1>Reference Implementation OSLC (RIO)<br/> for Requirements Management<br/>Setup</h1></td></tr></table>
...
<input type="hidden" name="context" value="rio-rm"/>
