 ...
 */
public class RequirementCollectionSelectorService extends RioBaseService {
	private static final long serialVersionUID = -7686676669514351988L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( terms != null ) {
			...
			// redirect to jsp
			RequestDispatcher rd = request.getRequestDispatcher("/rm/reqcol_selector.jsp"); //$NON-NLS-1$
...
//		}
		...
		query.append("  ?about rdf:type <" + IRmConstants.OSLC_RM_TYPE_REQUIREMENTCOLLECTION+">;\n");
