 ...
 */
public class LinkTypeSelectorService extends RioBaseService {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( terms != null ) {
			...
			// redirect to jsp
			RequestDispatcher rd = request.getRequestDispatcher("/am/linktype_selector.jsp"); //$NON-NLS-1$
...
//		}
		...
		query.append("  ?about rdf:type <http://open-services.net/ns/am#LinkType>;\n");
