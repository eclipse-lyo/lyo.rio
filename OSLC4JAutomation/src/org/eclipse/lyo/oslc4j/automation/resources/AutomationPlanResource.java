...
public class AutomationPlanResource extends BaseAutoResource<AutomationPlan> {
    ...
    @OslcDialogs(
    {
        ...
        (
             ...
             hintWidth = "1000px",
             hintHeight = "600px",
             resourceTypes = {Constants.TYPE_AUTO_PLAN},
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + Constants.PATH_AUTO_PLAN,
        resourceTypes = {Constants.TYPE_AUTO_PLAN},
        usages = {OslcConstants.OSLC_USAGE_DEFAULT}
    )
    @GET
    ...
    (
         ...
         resourceShapes = {OslcConstants.PATH_RESOURCE_SHAPES + "/" + Constants.PATH_AUTO_PLAN},
         resourceTypes = {Constants.TYPE_AUTO_PLAN},
         usages = {OslcConstants.OSLC_USAGE_DEFAULT}
    )
    @POST
