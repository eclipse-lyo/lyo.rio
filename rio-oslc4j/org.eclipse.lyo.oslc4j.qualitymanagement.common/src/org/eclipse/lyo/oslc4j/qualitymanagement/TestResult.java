...
@OslcResourceShape(title = "Quality Management Resource Shape", describes = Constants.TYPE_TEST_RESULT)
       ...
       extends QmResource
{
    ...
    protected URI getRdfType() {
    	return URI.create(Constants.TYPE_TEST_RESULT);
    }
    ...
    @OslcPropertyDefinition(Constants.QUALITY_MANAGEMENT_NAMESPACE + "affectedByChangeRequest")
    ...
    @OslcPropertyDefinition(Constants.QUALITY_MANAGEMENT_NAMESPACE + "reportsOnTestPlan")
    ...
    @OslcPropertyDefinition(Constants.QUALITY_MANAGEMENT_NAMESPACE + "reportsOnTestCase")
    ...
    @OslcPropertyDefinition(Constants.QUALITY_MANAGEMENT_NAMESPACE + "executesTestScript")
    ...
    @OslcPropertyDefinition(Constants.QUALITY_MANAGEMENT_NAMESPACE + "producedByTestExecutionRecord")
    ...
    @OslcPropertyDefinition(Constants.QUALITY_MANAGEMENT_NAMESPACE + "status")
    @OslcTitle("Status")
