...
/**
 * @see http://open-services.net/wiki/automation/OSLC-Automation-Specification-Version-2.0/
 */
public abstract class AutomationResource
       extends AbstractResource
{
    protected final Set<URI>      rdfTypes                    = new TreeSet<URI>();
    protected final Set<URI>      contributors                = new TreeSet<URI>();
    protected final Set<URI>      creators                    = new TreeSet<URI>();
    
    protected Date     created;
    protected String   identifier;
    protected URI      instanceShape;
    protected Date     modified;
    protected URI      serviceProvider;
    ...
    public AutomationResource()
     ...
     public AutomationResource(final URI about)
     {
         super(about);
