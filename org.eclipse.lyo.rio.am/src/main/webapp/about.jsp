...
<title>About RIO OSLC-AM</title>
</head>
<body>
<table><tr><td><a href="<%=uriBase%>"><img border="0" src="oslcLg.png"/></a></td><td><h2>About:<br/>Reference Implementation OSLC (RIO)<br/> for Architecture Management</h2></td></tr></table>
<p>This service provider is a minmal reference implementation of the Open Services for 
Lifecycle Connectivity (OSLC) Architecture Management specification.  The official specification
is available on the <a href="http://open-services.net/bin/view/Main/AmSpecV2">OSLC AM Wiki</a></p>

<p>This application is distributed under a <a href="license/rio.jsp">Eclipse Distribution License Version 1.0 and the Eclipse Public License 1.0</a>. </p> 
