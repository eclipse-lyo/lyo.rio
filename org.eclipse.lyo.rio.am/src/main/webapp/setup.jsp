...
<title>Simple OSLC AM Reference Implementation Setup</title>
</head>
<body>
<table><tr><td><a href="/rio-am"><img border="0" src="oslcLg.png"/></a></td><td><h1>Reference Implementation OSLC (RIO)<br/> for Architecture Management<br/>Setup</h1></td></tr></table>
...
<input type="hidden" name="context" value="rio-am"/>
...
<input type="submit" name="Configure" value="Configue"/>
