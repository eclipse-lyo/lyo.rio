...
<%
    ...
    Map<String,String> testPlans = (Map<String,String>) request.getAttribute("testPlans");
%>
<html>
<head>
			...
			<table class="ui-widget-content" id="inputTable">
				...
				<td>
					<select class="ui-widget select" id="plan">
						<%
							for (String id : testPlans.keySet()) {
								String title = testPlans.get(id);
						%>
						<option value="<%=id%>" id="testPlan"><%=id%>: <%=title%></option>
						<%
							}
						%>
					</select>
