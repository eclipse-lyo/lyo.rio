       ...
       extends TestCase
{
    ...
    private void verifyQmResource(final String        mediaType,
                                            final AutomationResource qmResource,
              ...
              throws URISyntaxException
    {
        ...
        final AutomationResource addedResource = oslcRestClient.addOslcResource(qmResource);
              ...
              throws URISyntaxException
    {
        ...
        final AutomationResource[] qmResources = oslcRestClient.getOslcResources(resourceArrayType);
        ...
        for (final AutomationResource qmResource : qmResources)
        {
            verifyQmResource(mediaType,
                                qmResource,
                                true);
              ...
              throws URISyntaxException
    {
        ...
        final AutomationResource updatedQmResource = oslcRestClient.getOslcResource(resourceType);
